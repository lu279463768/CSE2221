...
public final class StringReassembly {
    ...
    public static void addToSetAvoidingSubstrings(Set<String> strSet,
        ...
        /*
         * check precondition:CONTAINS_NO_SUBSTRING_PAIRS(strSet)
         */
        for (String s : strSet) {
            tempSet.add(s);
        }
            ...
            for (String t : strSet) {
                if (s.contains(t)) {
                    Reporter.fatalErrorToConsole(
                            "Violation of: CONTAINS_NO_SUBSTRING_PAIRS(strSet)");
                }
            }
            strSet.add(s);
        }
        ...
        /*
         * check if SUPERSTRINGS(#strSet, str) = {}
         */
        boolean isAdd = true;
        for (String s : strSet) {
            if (s.contains(str)) {
        ...
        /*
         * if it is added, removes from strSet any string already in strSet that
