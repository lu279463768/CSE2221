...
//        }
    ...
    private static void printWithCommas(NaturalNumber n, SimpleWriter out) {
        ...
        NaturalNumber thousand = new NaturalNumber1L(1000);
        ...
        if (!n.isZero()) {
            /**
             * test if the remainder is less three digits
             */
            /**
             * can use divided by ten and assemble the digits together
             */
            NaturalNumber tempRemainder = new NaturalNumber1L(remainder);
            NaturalNumber remainder1 = tempRemainder.divide(ten);
            NaturalNumber remainder2 = tempRemainder.divide(ten);
            NaturalNumber remainder3 = tempRemainder.divide(ten);
            res = "," + remainder3 + "" + remainder2 + "" + remainder1;
            res = toStringWithCommas(n) + res;
        }
