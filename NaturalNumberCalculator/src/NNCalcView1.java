...
public final class NNCalcView1 extends JFrame implements NNCalcView {
    ...
    public NNCalcView1() {
        ...
        for (int i = 0; i < DIGIT_BUTTONS; i++) {
            ...
            this.bDigits[i].setEnabled(true);
         ...
         */
        JPanel comButtonPanel = new JPanel(new FlowLayout());

        /*
         * Add the other two button panels to the combined button panel
         */
        comButtonPanel.add(buttonPanel);
        comButtonPanel.add(sideButtonPanel);
